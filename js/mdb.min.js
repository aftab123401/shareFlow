jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {def: "easeOutQuad", swing: function (t, e, i, n, s) {
        ...
        if (o || (o = .3 * s), r < Math.abs(n)) {
            ...
            var a = o / (2 * Math.PI) * Math.asin(n / r);
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity, jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (!function (t) {
    ...
    if (!t.jQuery) {
        ...
        i.isWindow = function (t) {
            ...
            var s = t[i.expando], a = s && n[s];
            a && i.each(e, function (t, e) {
                delete a[e]
            })
        }, i.extend = function () {
            var t, e, n, s, a, o, r = arguments[0] || {}, l = 1, h = arguments.length, u = !1;
            for ("boolean" == typeof r && (u = r, r = arguments[l] || {}, l++), "object" != typeof r && "function" !== i.type(r) && (r = {}), l === h && (r = this, l--); h > l; l++)
                if (null != (a = arguments[l]))
                    for (s in a)
                        t = r[s], n = a[s], r !== n && (u && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, o = t && i.isArray(t) ? t : []) : o = t && i.isPlainObject(t) ? t : {}, r[s] = i.extend(u, o, n)) : void 0 !== n && (r[s] = n));
            return r
            ...
            i.each(t.nodeType ? [t] : t, function (t, n) {
                ...
                var e = this[0], t = t.apply(e), n = this.offset(), s = /^(?:body|html)$/i.test(t.nodeName) ? {top: 0, left: 0} : i(t).offset();
    ...
    return function (t, e, i, n) {
        ...
        function l(t, i, n, s) {
            ...
            function f(e, i, s) {
                var a, o, r = 0;
                do
                    o = i + (s - i) / 2, a = l(o, t, n) - e, a > 0 ? s = o : i = o;
                while (Math.abs(a) > m && ++r < y);
                return o
            }
            function d(e) {
                for (var i = 0, s = 1, a = b - 1; s != a && C[s] <= e; ++s)
                    i += x;
                --s;
                var o = (e - C[s]) / (C[s + 1] - C[s]), r = i + o * x, l = h(r, t, n);
                return l >= v ? u(e, r) : 0 == l ? r : f(e, i, i + x)
            }
            function p() {
                P = !0, (t != i || n != s) && c()
            }
            var g = 4, v = .001, m = 1e-7, y = 10, b = 11, x = 1 / (b - 1), w = "Float32Array"in e;
            ...
            var C = w ? new Float32Array(b) : new Array(b), P = !1, k = function (e) {
                return P || p(), t === i && n === s ? e : 0 === e ? 0 : 1 === e ? 1 : l(d(e), i, s)
            };
            k.getControlPoints = function () {
                return[{x: t, y: i}, {x: n, y: s}]
            };
        ...
        function h(t, e) {
            var i = t;
            return g.isString(t) ? b.Easings[t] || (i = !1) : i = g.isArray(t) && 1 === t.length ? r.apply(null, t) : g.isArray(t) && 2 === t.length ? x.apply(null, t.concat([e])) : g.isArray(t) && 4 === t.length ? l.apply(null, t) : !1, i === !1 && (i = b.Easings[b.defaults.easing] ? b.defaults.easing : y), i
        }
        function u(t) {
            if (t) {
                    ...
                    if (b.State.calls[a]) {
                        ...
                        for (var m = Math.min((e - d) / h.duration, 1), y = 0, x = l.length; x > y; y++) {
                            ...
                            if (o(P)) {
                                ...
                                if (h.display !== n && null !== h.display && "none" !== h.display) {
                                    if ("flex" === h.display) {
                                        ...
                                        f.each(L, function (t, e) {
                                            w.setPropertyValue(P, "display", e)
                                        })
                                    }
                                ...
                                for (var A in S)
                                    if ("element" !== A) {
                                        var T, F = S[A], M = g.isString(F.easing) ? b.Easings[F.easing] : F.easing;
                                        if (1 === m)
                                            T = F.endValue;
                                        else {
                                            var E = F.endValue - F.startValue;
                                            if (T = F.startValue + E * M(m, h, E), !p && T === F.currentValue)
                                                continue
                                        }
                                        if (F.currentValue = T, "tween" === A)
                                            v = T;
                                        else {
                                            if (w.Hooks.registered[A]) {
                                                var V = w.Hooks.getRoot(A), R = o(P).rootPropertyValueCache[V];
            ...
            for (var i = b.State.calls[t][0], s = b.State.calls[t][1], a = b.State.calls[t][2], r = b.State.calls[t][4], l = !1, h = 0, u = i.length; u > h; h++) {
                ...
                if (e || a.loop || ("none" === a.display && w.setPropertyValue(c, "display", a.display), "hidden" === a.visibility && w.setPropertyValue(c, "visibility", a.visibility)), a.loop !== !0 && (f.queue(c)[1] === n || !/\.velocityQueueEntryFlag/i.test(f.queue(c)[1])) && o(c)) {
                    ...
                    f.each(w.Lists.transforms3D, function (t, e) {
                        var i = /^scale/.test(e) ? 1 : 0, s = o(c).transformCache[e];
                ...
                r && a.loop !== !0 && r(s), o(c) && a.loop === !0 && !e && (f.each(o(c).tweensContainer, function (t, e) {
                    /^rotate/.test(t) && 360 === parseFloat(e.endValue) && (e.endValue = 0, e.startValue = 360), /^backgroundPosition/.test(t) && 100 === parseFloat(e.endValue) && "%" === e.unitType && (e.endValue = 0, e.startValue = 100)
                }), b(c, "reverse", {loop: !0, delay: a.delay})), a.queue !== !1 && f.dequeue(c, a.queue)
            }
            b.State.calls[t] = !1;
        ...
        var m = 400, y = "swing", b = {State: {isMobile: /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), isAndroid: /Android/i.test(navigator.userAgent), isGingerbread: /Android 2\.3\.[3-7]/i.test(navigator.userAgent), isChrome: e.chrome, isFirefox: /Firefox/i.test(navigator.userAgent), prefixElement: i.createElement("div"), prefixMatches: {}, scrollAnchor: null, scrollPropertyLeft: null, scrollPropertyTop: null, isTicking: !1, calls: []}, CSS: {}, Utilities: f, Redirects: {}, Easings: {}, Promise: e.Promise, defaults: {queue: "", duration: m, easing: y, begin: n, complete: n, progress: n, display: n, visibility: n, loop: !1, delay: !1, mobileHA: !0, _cacheValues: !0}, init: function (t) {
                f.data(t, "velocity", {isSVG: g.isSVG(t), isAnimating: !1, computedStyle: null, tweensContainer: null, rootPropertyValueCache: {}, transformCache: {}})
        ...
        var x = function () {
            ...
            function i(i, n) {
                var s = {dx: i.v, dv: t(i)}, a = e(i, .5 * n, s), o = e(i, .5 * n, a), r = e(i, n, o), l = 1 / 6 * (s.dx + 2 * (a.dx + o.dx) + r.dx), h = 1 / 6 * (s.dv + 2 * (a.dv + o.dv) + r.dv);
                return i.x = i.x + l * n, i.v = i.v + h * n, i
            }
            return function n(t, e, s) {
                var a, o, r, l = {x: -1, v: 0, tension: null, friction: null}, h = [0], u = 0, c = 1e-4, f = .016;
        ...
        var w = b.CSS = {RegEx: {isHex: /^#([A-f\d]{3}){1,2}$/i, valueUnwrap: /^[A-z]+\((.*)\)$/i, wrappedValueAlreadyExtracted: /[0-9.]+ [0-9.]+ [0-9.]+( [0-9.]+)?/, valueSplit: /([A-z]+\(.+\))|(([A-z0-9#-.]+?)(?=\s|$))/gi}, Lists: {colors: ["fill", "stroke", "stopColor", "color", "backgroundColor", "borderColor", "borderTopColor", "borderRightColor", "borderBottomColor", "borderLeftColor", "outlineColor"], transformsBase: ["translateX", "translateY", "scale", "scaleX", "scaleY", "skewX", "skewY", "rotateZ"], transforms3D: ["transformPerspective", "translateZ", "scaleZ", "rotateX", "rotateY"]}, Hooks: {templates: {textShadow: ["Color X Y Blur", "black 0px 0px 0px"], boxShadow: ["Color X Y Blur Spread", "black 0px 0px 0px 0px"], clip: ["Top Right Bottom Left", "0px 0px 0px 0px"], backgroundPosition: ["X Y", "0% 0%"], transformOrigin: ["X Y Z", "50% 50% 0px"], perspectiveOrigin: ["X Y", "50% 50%"]}, registered: {}, register: function () {
                    ...
                    if (d)
                        for (i in w.Hooks.templates) {
                            ...
                            "Color" === s[0] && (s.push(s.shift()), a.push(a.shift()), w.Hooks.templates[i] = [s.join(" "), a.join(" ")])
                        }
                    for (i in w.Hooks.templates) {
                        n = w.Hooks.templates[i], s = n[0].split(" ");
                        for (var t in s) {
                    ...
                    return i
                }}, Normalizations: {registered: {clip: function (t, e, i) {
                        switch (t) {
                            case"name":
                                return"clip";
                            case"extract":
                        ...
                        !function () {
                            ...
                            w.Normalizations.registered[e] = function (t, i, s) {
                                switch (t) {
                                    ...
                                    case"extract":
                                        var a;
                                        if (w.RegEx.wrappedValueAlreadyExtracted.test(s))
                                            a = s;
                                        else {
                                            var o, r = {black: "rgb(0, 0, 0)", blue: "rgb(0, 0, 255)", gray: "rgb(128, 128, 128)", green: "rgb(0, 128, 0)", red: "rgb(255, 0, 0)", white: "rgb(255, 255, 255)"};
                                            /^[A-z]+$/i.test(s) ? o = r[s] !== n ? r[s] : r.black : w.RegEx.isHex.test(s) ? o = "rgb(" + w.Values.hexToRgb(s).join(" ") + ")" : /^rgba?\(/i.test(s) || (o = r.black), a = (o || s).toString().match(w.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                        }
                    ...
                    for (var e = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = e.length; n > i; i++) {
                        ...
                        }), g.isString(b.State.prefixElement.style[s]))
                ...
                function r(t, i) {
                    ...
                    if (8 >= d)
                        ...
                        var h = !1;
                        if (/^(width|height)$/.test(i) && 0 === w.getPropertyValue(t, "display") && (h = !0, w.setPropertyValue(t, "display", w.Values.getDisplayType(t))), !a) {
                            ...
                            if ("width" === i && "border-box" !== w.getPropertyValue(t, "boxSizing").toString().toLowerCase()) {
                                var c = t.offsetWidth - (parseFloat(w.getPropertyValue(t, "borderLeftWidth")) || 0) - (parseFloat(w.getPropertyValue(t, "borderRightWidth")) || 0) - (parseFloat(w.getPropertyValue(t, "paddingLeft")) || 0) - (parseFloat(w.getPropertyValue(t, "paddingRight")) || 0);
                                return s(), c
                            }
                        }
                        var p;
                ...
                else if (w.Normalizations.registered[i] && "transform" === w.Normalizations.registered[i]("name", t))
                    w.Normalizations.registered[i]("inject", t, n), r = "transform", n = o(t).transformCache[i];
                else {
                    if (w.Hooks.registered[i]) {
                        var l = i, h = w.Hooks.getRoot(i);
                        s = s || w.getPropertyValue(t, h), n = w.Hooks.injectValue(l, n, s), i = h
                    }
                    if (w.Normalizations.registered[i] && (n = w.Normalizations.registered[i]("inject", t, n), i = w.Normalizations.registered[i]("name", t)), r = w.Names.prefixCheck(i)[0], 8 >= d)
                        try {
                            t.style[r] = n
                        } catch (u) {
                        ...
                        o(t) && o(t).isSVG && w.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[r] = n;
        ...
        w.Hooks.register(), w.Normalizations.register(), b.hook = function (t, e, i) {
            ...
            return t = a(t), f.each(t, function (t, a) {
                if (o(a) === n && b.init(a), i === n)
                    s === n && (s = b.CSS.getPropertyValue(a, e));
                else {
        ...
        var S = function () {
            ...
            function s() {
                function t(t) {
                    ...
                    function m() {
                        var t = {myParent: a.parentNode || i.body, position: w.getPropertyValue(a, "position"), fontSize: w.getPropertyValue(a, "fontSize")}, n = t.position === O.lastPosition && t.myParent === O.lastParent, s = t.fontSize === O.lastFontSize;
                        O.lastParent = t.myParent, O.lastPosition = t.position, O.lastFontSize = t.fontSize;
                        var r = 100, l = {};
                        if (s && n)
                            l.emToPx = O.lastEmToPx, l.percentToPxWidth = O.lastPercentToPxWidth, l.percentToPxHeight = O.lastPercentToPxHeight;
                        else {
                            var h = o(a).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                            b.init(h), t.myParent.appendChild(h), f.each(["overflow", "overflowX", "overflowY"], function (t, e) {
                                b.CSS.setPropertyValue(h, e, "hidden")
                            }), b.CSS.setPropertyValue(h, "position", t.position), b.CSS.setPropertyValue(h, "fontSize", t.fontSize), b.CSS.setPropertyValue(h, "boxSizing", "content-box"), f.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function (t, e) {
                                b.CSS.setPropertyValue(h, e, r + "%")
                            }), b.CSS.setPropertyValue(h, "paddingLeft", r + "em"), l.percentToPxWidth = O.lastPercentToPxWidth = (parseFloat(w.getPropertyValue(h, "width", null, !0)) || 1) / r, l.percentToPxHeight = O.lastPercentToPxHeight = (parseFloat(w.getPropertyValue(h, "height", null, !0)) || 1) / r, l.emToPx = O.lastEmToPx = (parseFloat(w.getPropertyValue(h, "paddingLeft")) || 1) / r, t.myParent.removeChild(h)
                        }
                    ...
                    if ("scroll" === T) {
                        var S, k, L, F = /^x$/i.test(r.axis) ? "Left" : "Top", M = parseFloat(r.offset) || 0;
                        ...
                        if (!o(a).tweensContainer)
                            return void f.dequeue(a, r.queue);
                        ...
                        for (var W in v) {
                            var I = c(v[W]), B = I[0], H = I[1], j = I[2];
                            W = w.Names.camelCase(W);
                            var N = w.Hooks.getRoot(W), D = !1;
                            if (o(a).isSVG || "tween" === N || w.Names.prefixCheck(N)[1] !== !1 || w.Normalizations.registered[N] !== n) {
                                ...
                                var q, X, Y, $ = !1;
                                if (q = d(W, j), j = q[0], Y = q[1], q = d(W, B), B = q[0].replace(/^([+-\/*])=/, function (t, e) {
                                    return $ = e, ""
                                }), X = q[1], j = parseFloat(j) || 0, B = parseFloat(B) || 0,
                                        "%" === X && (/^(fontSize|lineHeight)$/.test(W) ? (B /= 100, X = "em") : /^scale/.test(W) ? (B /= 100, X = "") : /(Red|Green|Blue)$/i.test(W) && (B = B / 100 * 255, X = "")), /[\/*]/.test($))
                                    X = Y;
                                else if (Y !== X && 0 !== j)
                                    if (0 === B)
                                        X = Y;
                                ...
                                b.debug && console.log("Skipping [" + N + "] due to a lack of browser support.")
                        }
                        l.element = a
                    }
                ...
                var s, a = this, r = f.extend({}, b.defaults, y), l = {};
                switch (o(a) === n && b.init(a), parseFloat(r.delay) && r.queue !== !1 && f.queue(a, r.queue, function (t) {
                        b.velocityQueueEntryFlag = !0, o(a).delayTimer = {setTimeout: setTimeout(t, parseFloat(r.delay)), next: t}
            ...
            if (g.isWrapped(this) ? (r = !1, d = 0, p = this, l = this) : (r = !0, d = 1, p = x ? arguments[0].elements || arguments[0].e : arguments[0]), p = a(p)) {
                ...
                if (!/^(stop|finish)$/i.test(v) && !f.isPlainObject(y)) {
                    ...
                    for (var L = k; L < arguments.length; L++)
                        g.isArray(arguments[L]) || !/^(fast|normal|slow)$/i.test(arguments[L]) && !/^\d/.test(arguments[L]) ? g.isString(arguments[L]) || g.isArray(arguments[L]) ? y.easing = arguments[L] : g.isFunction(arguments[L]) && (y.complete = arguments[L]) : y.duration = arguments[L]
                }
                ...
                switch (v) {
                    ...
                    case"stop":
                        ...
                        return f.each(b.State.calls, function (t, e) {
                            e && f.each(e[1], function (i, s) {
                                var a = y === n ? "" : y;
                                return a === !0 || e[2].queue === a || y === n && e[2].queue === !1 ? void f.each(p, function (i, n) {
                                    n === s && ((y === !0 || g.isString(y)) && (f.each(f.queue(n, g.isString(y) ? y : ""), function (t, e) {
                                        g.isFunction(e) && e(null, !0)
                                    }), f.queue(n, g.isString(y) ? y : "", [])), "stop" === v ? (o(n) && o(n).tweensContainer && a !== !1 && f.each(o(n).tweensContainer, function (t, e) {
                                        e.endValue = e.currentValue
                                    }), F.push(t)) : "finish" === v && (e[2].duration = 1))
                                }) : !0
                            })
                        }), "stop" === v && (f.each(F, function (t, e) {
                            c(e, !0)
                        }), A.promise && A.resolver(p)), t();
                    default:
                        if (!f.isPlainObject(v) || g.isEmptyObject(v)) {
                            if (g.isString(v) && b.Redirects[v]) {
                                var M = f.extend({}, y), E = M.duration, V = M.delay || 0;
                                return M.backwards === !0 && (p = f.extend(!0, [], p).reverse()), f.each(p, function (t, e) {
                                    parseFloat(M.stagger) ? M.delay = V + parseFloat(M.stagger) * t : g.isFunction(M.stagger) && (M.delay = V + M.stagger.call(e, t, C)), M.drag && (M.duration = parseFloat(E) || (/^(callout|transition)/.test(v) ? 1e3 : m), M.duration = Math.max(M.duration * (M.backwards ? 1 - t / C : (t + 1) / C), .75 * M.duration, 200)), b.Redirects[v].call(e, e, M || {}, t, C, p, A.promise ? A : n)
                                }), t()
                            }
                ...
                var O = {lastParent: null, lastPosition: null, lastFontSize: null, lastPercentToPxWidth: null, lastPercentToPxHeight: null, lastEmToPx: null, remToPx: null, vwToPx: null, vhToPx: null}, z = [];
                f.each(p, function (t, e) {
                    g.isNode(e) && s.call(e)
                });
        ...
        return b.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
            ...
            b.Redirects["slide" + e] = function (t, i, s, a, o, r) {
                var l = f.extend({}, i), h = l.begin, u = l.complete, c = {height: "", marginTop: "", marginBottom: "", paddingTop: "", paddingBottom: ""}, d = {};
            ...
            b.Redirects["fade" + e] = function (t, i, s, a, o, r) {
                var l = f.extend({}, i), h = {opacity: "In" === e ? 1 : 0}, u = l.complete;
    ...
    var t = this, e = t.Chart, i = function (t) {
        ...
        }, s = this.width = i(t.canvas, "Width") || t.canvas.width, a = this.height = i(t.canvas, "Height") || t.canvas.height;
    ...
    var n = i.helpers = {}, s = n.each = function (t, e, i) {
    ...
    }, v = n.amd = "function" == typeof define && define.amd, m = n.isNumber = function (t) {
        return!isNaN(parseFloat(t)) && isFinite(t)
    }, y = n.max = function (t) {
        return Math.max.apply(Math, t)
    }, b = n.min = function (t) {
        return Math.min.apply(Math, t)
    }, w = (n.cap = function (t, e, i) {
        if (m(e)) {
            if (t > e)
                return e
        } else if (m(i) && i > t)
        ...
        var s = Math.sqrt(Math.pow(e.x - t.x, 2) + Math.pow(e.y - t.y, 2)), a = Math.sqrt(Math.pow(i.x - e.x, 2) + Math.pow(i.y - e.y, 2)), o = n * s / (s + a), r = n * a / (s + a);
        ...
        var o = 2, r = Math.floor(e / (1.5 * i)), l = o >= r, h = [];
        s(t, function (t) {
            null == t || h.push(t)
        });
        var u = b(h), c = y(h);
        c === u && (c += .5, u >= .5 && !n ? u -= .5 : c += .5);
        for (var f = Math.abs(c - u), d = L(f), p = Math.ceil(c / (1 * Math.pow(10, d))) * Math.pow(10, d), g = n ? 0 : Math.floor(u / (1 * Math.pow(10, d))) * Math.pow(10, d), v = p - g, m = Math.pow(10, d), x = Math.round(v / m); (x > r || r > 2 * x) && !l; )
            if (x > r)
                m *= 2, x = Math.round(v / m), x % 1 !== 0 && (l = !0);
            else if (a && d >= 0) {
                if (m / 2 % 1 !== 0)
                    break;
    ...
    }, n.easingEffects = {linear: function (t) {
            return t
        ...
        var e = t.parentNode, i = parseInt(N(e, "padding-left")) + parseInt(N(e, "padding-right"));
        return e.clientWidth - i
    }, j = n.getMaximumHeight = function (t) {
        var e = t.parentNode, i = parseInt(N(e, "padding-bottom")) + parseInt(N(e, "padding-top"));
    ...
    }), X = n.clear = function (t) {
        t.ctx.clearRect(0, 0, t.width, t.height)
    }, Y = n.fontString = function (t, e, i) {
        return e + " " + t + "px " + i
    ...
    i.instances = {}, i.Type = function (t, e, n) {
        this.options = e, this.chart = n, this.id = p(), i.instances[this.id] = this, e.responsive && this.resize(), this.initialize.call(this, t)
    }, o(i.Type.prototype, {initialize: function () {
            return this
        }, clear: function () {
            return X(this.chart), this
        }, stop: function () {
            return i.animationService.cancelAnimation(this), this
        }, resize: function (t) {
            this.stop();
            var e = this.chart.canvas, i = H(this.chart.canvas), n = this.options.maintainAspectRatio ? i / this.chart.aspectRatio : j(this.chart.canvas);
            ...
            if (t && this.reflow(), this.options.animation && !t) {
                ...
                e.numSteps = this.options.animationSteps, e.easing = this.options.animationEasing, e.render = function (t, e) {
                    var i = n.easingEffects[e.easing], s = e.currentStep / e.numSteps, a = i(s);
                ...
                if (this.activeElements = t, this.draw(), this.options.customTooltips && this.options.customTooltips(!1), t.length > 0)
                    if (this.datasets && this.datasets.length > 1) {
                        for (var o, r, h = this.datasets.length - 1; h >= 0 && (o = this.datasets[h].points || this.datasets[h].bars || this.datasets[h].segments, r = l(o, t[0]), - 1 === r); h--)
                            ;
                        var u = [], c = [], f = function (t) {
                            var i, o, l, h, f, e = [], s = [], a = [];
                            return n.each(this.datasets, function (t) {
                                i = t.points || t.bars || t.segments, i[r] && i[r].hasValue() && e.push(i[r])
                            }), n.each(e, function (t) {
                                s.push(t.x), a.push(t.y), u.push(n.template(this.options.multiTooltipTemplate, t)), c.push({fill: t._saved.fillColor || t.fillColor, stroke: t._saved.strokeColor || t.strokeColor})
                            }, this), f = b(a), l = y(a), h = b(s), o = y(s), {x: h > this.chart.width / 2 ? h : o, y: (f + l) / 2}
                        }.call(this, r);
        ...
        o(this, t), this.initialize.apply(this, arguments), this.save()
    }, o(i.Element.prototype, {initialize: function () {
        }, restore: function (t) {
            ...
            return m(this.value)
        }}), i.Element.extend = f, i.Point = i.Element.extend({display: !0, inRange: function (t, e) {
        ...
        }}), i.Arc = i.Element.extend({inRange: function (t, e) {
            var i = n.getAngleFromPoint(this, {x: t, y: e}), s = i.angle % (2 * Math.PI), a = (2 * Math.PI + this.startAngle) % (2 * Math.PI), o = (2 * Math.PI + this.endAngle) % (2 * Math.PI) || 360, r = a > o ? o >= s || s >= a : s >= a && o >= s, l = i.distance >= this.innerRadius && i.distance <= this.outerRadius;
            return r && l
        }, tooltipPosition: function () {
        ...
        }}), i.Rectangle = i.Element.extend({draw: function () {
            var t = this.ctx, e = this.width / 2, i = this.x - e, n = this.x + e, s = this.base - (this.base - this.y), a = this.strokeWidth / 2;
        ...
        }}), i.Animation = i.Element.extend({currentStep: null, numSteps: 60, easing: "", render: null, onAnimationProgress: null, onAnimationComplete: null}), i.Tooltip = i.Element.extend({draw: function () {
        ...
        }}), i.MultiTooltip = i.Element.extend({initialize: function () {
            ...
            var t = this.ctx.measureText(this.title).width, e = $(this.ctx, this.font, this.labels) + this.fontSize + 3, i = y([e, t]);
        ...
        }}), i.Scale = i.Element.extend({initialize: function () {
            this.fit()
        }, buildYLabels: function () {
            this.yLabels = [];
            for (var t = w(this.stepValue), e = 0; e <= this.steps; e++)
                this.yLabels.push(T(this.templateString, {value: (this.min + e * this.stepValue).toFixed(t)}));
            ...
            if (this.xScalePaddingRight = e / 2 + 3, this.xScalePaddingLeft = t / 2 > this.yLabelWidth ? t / 2 : this.yLabelWidth, this.xLabelRotation = 0, this.display) {
                ...
                for (var r = Math.floor(this.calculateX(1) - this.calculateX(0)) - 6; this.xLabelWidth > r && 0 === this.xLabelRotation || this.xLabelWidth > r && this.xLabelRotation <= 90 && this.xLabelRotation > 0; )
                    a = Math.cos(S(this.xLabelRotation)), i = a * t, n = a * e, i + this.fontSize / 2 > this.yLabelWidth && (this.xScalePaddingLeft = i + this.fontSize / 2), this.xScalePaddingRight = this.fontSize / 2, this.xLabelRotation++, this.xLabelWidth = a * s;
        ...
        }, calculateYRange: d, drawingArea: function () {
            return this.startPoint - this.endPoint
        }, calculateY: function (t) {
            var e = this.drawingArea() / (this.min - this.max);
            return this.endPoint - e * (t - this.min)
        }, calculateX: function (t) {
            var i = (this.xLabelRotation > 0, this.width - (this.xScalePaddingLeft + this.xScalePaddingRight)), n = i / Math.max(this.valuesCount - (this.offsetGridLines ? 0 : 1), 1), s = n * t + this.xScalePaddingLeft;
            ...
            this.display && (t.fillStyle = this.textColor, t.font = this.font, s(this.yLabels, function (s, a) {
                ...
                var n = this.calculateX(i) + P(this.lineWidth), s = this.calculateX(i - (this.offsetGridLines ? .5 : 0)) + P(this.lineWidth), a = this.xLabelRotation > 0, o = this.showVerticalLines;
        ...
        }}), i.RadialScale = i.Element.extend({initialize: function () {
            ...
            var e, i, n, s, o, r, h, u, c, f, d, p, t = b([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]), a = this.width, l = 0;
            for (this.ctx.font = Y(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), i = 0; i < this.valuesCount; i++)
                e = this.getPointPosition(i, t), n = this.ctx.measureText(T(this.templateString, {value: this.labels[i]})).width + 5, 0 === i || i === this.valuesCount / 2 ? (s = n / 2, e.x + s > a && (a = e.x + s, o = i), e.x - s < l && (l = e.x - s, h = i)) : i < this.valuesCount / 2 ? e.x + n > a && (a = e.x + n, o = i) : i > this.valuesCount / 2 && e.x - n < l && (l = e.x - n, h = i);
            ...
            if (this.display) {
                ...
                if (s(this.yLabels, function (e, i) {
                    if (i > 0) {
                        var a, n = i * (this.drawingArea / this.steps), s = this.yCenter - n;
                        if (this.lineWidth > 0)
                    ...
                    for (var e = this.valuesCount - 1; e >= 0; e--) {
                        ...
                        if (this.angleLineWidth > 0 && (i = this.calculateCenterOffset(this.max), n = this.getPointPosition(e, i), t.beginPath(), t.moveTo(this.xCenter, this.yCenter), t.lineTo(n.x, n.y), t.stroke(), t.closePath()), this.backgroundColors && this.backgroundColors.length == this.valuesCount) {
                            ...
                            var a = this.getPointPosition(0 === e ? this.valuesCount - 1 : e - 1, i), o = this.getPointPosition(e === this.valuesCount - 1 ? 0 : e + 1, i), r = {x: (a.x + n.x) / 2, y: (a.y + n.y) / 2}, l = {x: (n.x + o.x) / 2, y: (n.y + o.y) / 2};
                        ...
                        var u = this.labels.length, c = this.labels.length / 2, f = c / 2, d = f > e || e > u - f, p = e === f || e === u - f;
        ...
        }}), i.animationService = {frameDuration: 17, animations: [], dropFrames: 0, addAnimation: function (t, e) {
            ...
            var s = Date.now(), a = s - t - this.frameDuration, o = a / this.frameDuration;
    ...
    "use strict";
    var t = this, e = t.Chart, i = e.helpers, n = {scaleBeginAtZero: !0, scaleShowGridLines: !0, scaleGridLineColor: "rgba(0,0,0,.05)", scaleGridLineWidth: 1, scaleShowHorizontalLines: !0, scaleShowVerticalLines: !0, barShowStroke: !0, barStrokeWidth: 2, barValueSpacing: 5, barDatasetSpacing: 1, legendTemplate: '<ul class="<%=name.toLowerCase()%>-legend"><% for (var i=0; i<datasets.length; i++){%><li><span style="background-color:<%=datasets[i].fillColor%>"><%if(datasets[i].label){%><%=datasets[i].label%><%}%></span></li><%}%></ul>'};
    e.Type.extend({name: "Bar", defaults: n, initialize: function (t) {
            ...
            this.ScaleClass = e.Scale.extend({offsetGridLines: !0, calculateBarX: function (t, e, i) {
                ...
                this.datasets.push(s), i.each(e.data, function (i, n) {
                    s.bars.push(new this.BarClass({value: i, label: t.labels[n], datasetLabel: e.label, strokeColor: e.strokeColor, fillColor: e.fillColor, highlightFill: e.highlightFill || e.fillColor, highlightStroke: e.highlightStroke || e.strokeColor}))
                }, this)
            ...
            for (var a, e = [], n = i.getRelativePosition(t), s = function (t) {
                ...
                for (a = 0; a < this.datasets[o].bars.length; a++)
                    if (this.datasets[o].bars[a].inRange(n.x, n.y))
                        return i.each(this.datasets, s), e;
            return e
    ...
    e.Type.extend({name: "Doughnut", defaults: n, initialize: function (t) {
    ...
    "use strict";
    var t = this, e = t.Chart, i = e.helpers, n = {scaleShowGridLines: !0, scaleGridLineColor: "rgba(0,0,0,.05)", scaleGridLineWidth: 1, scaleShowHorizontalLines: !0, scaleShowVerticalLines: !0, bezierCurve: !0, bezierCurveTension: .4, pointDot: !0, pointDotRadius: 4, pointDotStrokeWidth: 1, pointHitDetectionRadius: 20, datasetStroke: !0, datasetStrokeWidth: 2, datasetFill: !0, legendTemplate: '<ul class="<%=name.toLowerCase()%>-legend"><% for (var i=0; i<datasets.length; i++){%><li><span style="background-color:<%=datasets[i].strokeColor%>"><%if(datasets[i].label){%><%=datasets[i].label%><%}%></span></li><%}%></ul>', offsetGridLines: !1};
    e.Type.extend({name: "Line", defaults: n, initialize: function (t) {
            this.PointClass = e.Point.extend({offsetGridLines: this.options.offsetGridLines, strokeWidth: this.options.pointDotStrokeWidth, radius: this.options.pointDotRadius, display: this.options.pointDot, hitDetectionRadius: this.options.pointHitDetectionRadius, ctx: this.chart.ctx, inRange: function (t) {
                ...
                this.datasets.push(n), i.each(e.data, function (i, s) {
                    n.points.push(new this.PointClass({value: i, label: t.labels[s], datasetLabel: e.label, strokeColor: e.pointStrokeColor, fillColor: e.pointColor, highlightFill: e.pointHighlightFill || e.pointColor, highlightStroke: e.pointHighlightStroke || e.pointStrokeColor}))
    ...
    "use strict";
    var t = this, e = t.Chart, i = e.helpers, n = {scaleShowLabelBackdrop: !0, scaleBackdropColor: "rgba(255,255,255,0.75)", scaleBeginAtZero: !0, scaleBackdropPaddingY: 2, scaleBackdropPaddingX: 2, scaleShowLine: !0, segmentShowStroke: !0, segmentStrokeColor: "#fff", segmentStrokeWidth: 2, animationSteps: 100, animationEasing: "easeOutBounce", animateRotate: !0, animateScale: !1, legendTemplate: '<ul class="<%=name.toLowerCase()%>-legend"><% for (var i=0; i<segments.length; i++){%><li><span style="background-color:<%=segments[i].fillColor%>"><%if(segments[i].label){%><%=segments[i].label%><%}%></span></li><%}%></ul>'};
    e.Type.extend({name: "PolarArea", defaults: n, initialize: function (t) {
    ...
    e.Type.extend({name: "Radar", defaults: {scaleShowLine: !0, angleShowLineOut: !0, scaleShowLabels: !1, scaleBeginAtZero: !0, angleLineColor: "rgba(0,0,0,.1)", angleLineWidth: 1, pointLabelFontFamily: "'Arial'", pointLabelFontStyle: "normal", pointLabelFontSize: 10, pointLabelFontColor: "#666", pointDot: !0, pointDotRadius: 3, pointDotStrokeWidth: 1, pointHitDetectionRadius: 20, datasetStroke: !0, datasetStrokeWidth: 2, datasetFill: !0, legendTemplate: '<ul class="<%=name.toLowerCase()%>-legend"><% for (var i=0; i<datasets.length; i++){%><li><span style="background-color:<%=datasets[i].strokeColor%>"><%if(datasets[i].label){%><%=datasets[i].label%><%}%></span></li><%}%></ul>'}, initialize: function (t) {
            ...
            var e = i.getRelativePosition(t), n = i.getAngleFromPoint({x: this.scale.xCenter, y: this.scale.yCenter}, e), s = 2 * Math.PI / this.scale.valuesCount, a = Math.round((n.angle - 1.5 * Math.PI) / s), o = [];
    ...
    e = function () {
        ...
        return s.prototype.defaults = {boxClass: "wow", animateClass: "animated", offset: 0, mobile: !0, live: !0, callback: null, scrollContainer: null}, s.prototype.init = function () {
            var t;
            ...
            if (this.stopped = !1, this.boxes = function () {
                var t, i, n, s;
                for (n = this.element.querySelectorAll("." + this.config.boxClass), s = [], t = 0, i = n.length; i > t; t++)
                    e = n[t], s.push(e);
                return s
            ...
            return this.disabled() || (this.util().addEvent(this.config.scrollContainer || window, "scroll", this.scrollHandler), this.util().addEvent(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live ? new t(function (t) {
                return function (e) {
                    ...
                    for (o = [], i = 0, n = e.length; n > i; i++)
                        a = e[i], o.push(function () {
                            var t, e, i, n;
                            for (i = a.addedNodes || [], n = [], t = 0, e = i.length; e > t; t++)
            ...
            if (null == t && (t = this.element), 1 === t.nodeType) {
                for (t = t.parentNode || t, s = t.querySelectorAll("." + this.config.boxClass), a = [], i = 0, n = s.length; n > i; i++)
                    e = s[i], o.call(this.all, e) < 0 ? (this.boxes.push(e), this.all.push(e), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(e, !0), a.push(this.scrolled = !0)) : a.push(void 0);
                return a
            }
            ...
            n = [];
            for (i in e)
                s = e[i], t["" + i] = s, n.push(function () {
                    var e, n, o, r;
                    for (o = this.vendors, r = [], e = 0, n = o.length; n > e; e++)
                        a = o[e], r.push(t["" + a + i.charAt(0).toUpperCase() + i.substr(1)] = s);
                    return r
                }.call(this));
            return n
        }, s.prototype.vendorCSS = function (t, e) {
            var i, s, a, o, r, l;
            for (r = n(t), o = r.getPropertyCSSValue(e), a = this.vendors, i = 0, s = a.length; s > i; i++)
                l = a[i], o = o || r.getPropertyCSSValue("-" + l + "-" + e);
            return o
            ...
            return!this.scrolled || (this.scrolled = !1, this.boxes = function () {
                var e, i, n, s;
                for (n = this.boxes, s = [], e = 0, i = n.length; i > e; e++)
                    t = n[e], t && (this.isVisible(t) ? this.show(t) : s.push(t));
                return s
    ...
    function a(t) {
        return s(t) ? t : 9 === t.nodeType && t.defaultView
    }
    function o(t) {
        var e = typeof t;
    ...
    function l(t) {
        var n = i.call(t);
        return"[object String]" === n ? e(t) : o(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(n) && t.hasOwnProperty("length") ? t : r(t) ? [t] : []
    }
    function h(t) {
        var e, i, n = {top: 0, left: 0}, s = t && t.ownerDocument;
    ...
    function d(t, e, i) {
        if (i) {
            ...
            var n = i.getAttribute("data-x"), s = i.getAttribute("data-y"), a = i.getAttribute("data-scale"), o = i.getAttribute("data-translate"), r = Date.now() - Number(i.getAttribute("data-hold")), l = 350 - r;
        ...
        if (null !== e) {
            ...
            if (p.registerEvent(t), "touchstart" === t.type && c.delay) {
                var i = !1, s = setTimeout(function () {
                    s = null, c.show(t, e)
                }, c.delay), a = function (n) {
                    s && (clearTimeout(s), s = null, c.show(t, e)), i || (i = !0, c.hide(n, e))
                }, o = function (t) {
                    s && (clearTimeout(s), s = null), a(t)
                };
                e.addEventListener("touchmove", o, !1), e.addEventListener("touchend", a, !1), e.addEventListener("touchcancel", a, !1)
            } else
                c.show(t, e), n && (e.addEventListener("touchend", c.hide, !1), e.addEventListener("touchcancel", c.hide, !1)), e.addEventListener("mouseup", c.hide, !1), e.addEventListener("mouseleave", c.hide, !1)
        }
    }
    var t = t || {}, e = document.querySelectorAll.bind(document), i = Object.prototype.toString, n = "ontouchstart"in window, c = {duration: 750, delay: 200, show: function (t, e, i) {
            if (2 === t.button)
                return!1;
            e = e || this;
            ...
            e = e || this;
            for (var i = e.getElementsByClassName("waves-rippling"), n = 0, s = i.length; s > n; n++)
                d(t, e, i[n])
        }}, f = {input: function (t) {
            var e = t.parentNode;
            if ("i" !== e.tagName.toLowerCase() || !e.classList.contains("waves-effect")) {
                ...
                var n = window.getComputedStyle(t, null), s = n.color, a = n.backgroundColor;
    ...
    return t.init = function (t) {
        ...
        for (var n, s, a = 0, o = t.length; o > a; a++)
            n = t[a], s = n.tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(s) && (f[s](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e)
    }, t.ripple = function (t, e) {
        t = l(t);
        var i = t.length;
        if (e = e || {}, e.wait = e.wait || 0, e.position = e.position || null, i)
            for (var n, s, a, o = {}, r = 0, u = {type: "mousedown", button: 1}, f = function (t, e) {
                return function () {
                    c.hide(t, e)
                }
            }; i > r; r++)
        ...
        t = l(t);
        for (var e = {type: "mouseup", button: 1}, i = 0, n = t.length; n > i; i++)
            c.hide(e, t[i])
    ...
    t(document).ready(function () {
        function s(e) {
            var n = e.css("font-family"), s = e.css("font-size");
